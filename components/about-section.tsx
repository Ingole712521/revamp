...
export function AboutSection() {
    return (
        <section id="bio" className="w-full py-20 border-t border-zinc-100 dark:border-zinc-900">
            <div className="max-w-4xl mx-auto px-4">
                <div className="mb-12">
                    <span className="text-zinc-500 dark:text-zinc-400 text-xs font-bold uppercase tracking-widest mb-2 block">About</span>
                    <h2 className="text-4xl font-black text-black dark:text-white uppercase tracking-tighter">Me</h2>
                </div>
                ...
                >
                    ...
                    <div className="flex-1 flex flex-col justify-center py-4">
                        <h3 className="text-3xl font-black text-black dark:text-white mb-6 uppercase tracking-tight">
                            {HERO.name}
                        </h3>
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-5">
                                {/* Use simple text-based skill representation or Lucide icons if applicable, 
                                    but here we'll use small badges with subtle styling matching the screenshot's 'icon only' feel */}
