...
export function BlogSection() {
    return (
        <section id="blogs" className="w-full py-20 border-t border-zinc-100 dark:border-zinc-900">
            <div className="max-w-4xl mx-auto px-4">
                <div className="mb-12">
                    ...
                    <h2 className="text-4xl font-black text-black dark:text-white uppercase tracking-tighter">Blogs</h2>
                </div>
